...
public class LootTableModifier {
  ...
  static {
    ...
    LOOT_TABLE_CONFIGS.put(BASTION_OTHER, new LootConfig(List.of(MainRegistry.BRONZE_SWORD.get(),MainRegistry.BRONZE_SPEAR.get(), MainRegistry.BRONZE_INGOT.get(), MainRegistry.BRONZE_NUGGET.get(), MainRegistry.BRONZE_BLOCK_ITEM.get()), true, true));
